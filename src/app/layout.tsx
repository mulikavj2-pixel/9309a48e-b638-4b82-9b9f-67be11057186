...
export const metadata: Metadata = {
  title: "Coffee Haven - Specialty Coffee & Cozy Cafe",
  description: "Discover artisanal coffee crafted by expert baristas. Fresh roasted single-origin beans in a warm, welcoming atmosphere.",
  keywords: "specialty coffee, artisan coffee, coffee shop, espresso, latte, cold brew",
  metadataBase: new URL("https://coffeehaven.com"),
  alternates: {
    canonical: "https://coffeehaven.com"
  },
  openGraph: {
    title: "Coffee Haven - Specialty Coffee & Cozy Cafe",
    description: "Discover artisanal coffee crafted by expert baristas. Fresh roasted single-origin beans in a warm, welcoming atmosphere.",
    ...
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765446188834-xdf8ff0i.jpg",
      alt: "Coffee Haven - Fresh brewed specialty coffee"
    }]
  },
  twitter: {
    ...
    title: "Coffee Haven - Specialty Coffee & Cozy Cafe",
    description: "Discover artisanal coffee crafted by expert baristas. Fresh roasted single-origin beans in a warm, welcoming atmosphere.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765446188834-xdf8ff0i.jpg"]
  },
  robots: {
    index: true,
    follow: true
